...
# Theater Seating Lab: This program calculates income from ticket sales for multiple theater sections. It prompts the user for ticket sales, validates input, and displays subtotals for each section and a final total. Named constants make it easy to adjust prices, seat counts, or add new sections.
...
def main():
    ...
    # Get tickets sold for each section
